...
density = pd.read_csv("./data/other/pop_density.csv", delimiter=';', decimal=',', thousands=' ')
academics = pd.read_csv("./data/other/percent_academics.csv", delimiter=';', decimal=',', thousands='.')
income = pd.read_csv("./data/other/income_per_capita.csv", delimiter=';', decimal=',', thousands='.')
